...
/*TabA7 Lite code for OT8-4085 by weiqiang at 20210325 start*/
int display_bias_enable(void)
{
	...
	if (NULL != strstr(lcm_cmdline, "hx83102e_hlt_hsd_fhdplus2408") || NULL != strstr(lcm_cmdline, "ft8201ab_dt_qunchuang_inx_vdo_fhdplus2408")){
	...
	else if (NULL != strstr(lcm_cmdline, "nt36523_hlt_mdt_incell_vdo")){
		/* set voltage with min & max*/
...
/*TabA7 Lite code for OT8-4085 by weiqiang at 20210325 end*/
